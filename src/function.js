...
if(count_area.hasOwnProperty('MillBay/Malahat')||count_area.hasOwnProperty('all')){ container +=`<div class = 'control-button-wrapper'> <button class='collapsible' >Mill Bay / Malahat</button><button class = 'button' id = 'MillBay/Malahat'></button></div><div class='content'>`;container += `<div id = 'list_MillBay/Malahat' class = 'list-region'></div></div>`;}
...
if(count_area.hasOwnProperty('NorthOyster/Diamond')||count_area.hasOwnProperty('all')){ container +=`<div class = 'control-button-wrapper'> <button class='collapsible' >North Oyster / Diamond</button><button class = 'button' id = 'NorthOyster/Diamond'></button></div><div class='content'>`;container += `<div id = 'list_NorthOyster/Diamond' class = 'list-region'></div></div>`;}
...
if(count_area.hasOwnProperty('Youbou/MeadeCreek')||count_area.hasOwnProperty('all')){ container +=`<div class = 'control-button-wrapper'> <button class='collapsible' >Youbou / Meade Creek</button><button class = 'button' id = 'Youbou/MeadeCreek'></button></div><div class='content'>`;container += `<div id = 'list_Youbou/MeadeCreek' class = 'list-region'></div></div>`;}
