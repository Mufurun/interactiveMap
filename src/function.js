...
//        console.log(w +" x "+h);
        ...
        if (w>h){
          ...
          if(Lp<Lm+Blaycon.right){
            moveX=Lp-Lm-Blaycon.right;
          }
          if(Lm+Bfilcon.left<Rp){
            moveX=Rp-Lm-Bfilcon.left;
          }          
        }else{
          if (Tp+Hp < HpMax+Bregcon.bottom+Hm/25) {
            moveY=Tp+Hp-HpMax - Hm/25 - Bregcon.bottom;
          }
          if(Lp<Lm){
            moveX=Lp-Lm;
          }
