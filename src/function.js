    ...
    HTML: 
      container: div (popup-content)
          ...
          additionalSource: ul (description)
              each_addSrc: li (each_descrpt_li) *3
...
//Is this really???
    ...
    //Additional Sources
        ...
        for (let i = 0; ((i<7)&&(list_addSrc[i] != '')); i++){
          ...
          each_addSrc.className = 'each_descrpt_li';
...
if(count_area.hasOwnProperty('Sayward')){count_area['StrathconaRegionalDistrict'] = 1;}
if(count_area.hasOwnProperty('Kyuquot/Nootka')){count_area['StrathconaRegionalDistrict'] = 1;}
...
if(count_area.hasOwnProperty('Kyuquot/Nootka')||count_area.hasOwnProperty('all')){ container +=`<div class = 'control-button-wrapper'> <button class='collapsible' >Kyuquot / Nootka</button><button class = 'button' id = 'Kyuquot/Nootka'></button></div><div class='content'>`;container += `<div id = 'list_Kyuquot/Nootka' class = 'list-region'></div></div>`;}
if(count_area.hasOwnProperty('Sayward')||count_area.hasOwnProperty('all')){ container +=`<div class = 'control-button-wrapper'> <button class='collapsible' >Sayward</button><button class = 'button' id = 'Sayward'></button></div><div class='content'>`;container += `<div id = 'list_Sayward' class = 'list-region'></div></div>`;}
...
else if(region =='Kyuquot/Nootka'){list.innerHTML = 'List of Sites in Kyuquot / Nootka';}
else if(region =='Sayward'){list.innerHTML = 'List of Sites in Sayward';}
